...
<body class="my-body-content">
	<form id="functionEditForm" name="functionEditForm" class="my-form-content">
		<table class="my-form-table-content">
			<tr>
				...
				<td class="my-form-table-td-content" style="width:200px;">
					<input id="function_code" name="function_code" type="text" class="form-control input-sm" style="width:180px;padding:5px;float:left;" readOnly>
				</td>
			</tr>
...
$(document).ready(function() {
	validator = $("#functionEditForm").validate({
		debug: true,
	...
	var url = "<%=context%>/app/sys/function/getFunctionInfo";
	url += "?t=" + new Date();
	...
	$.post(url, function(data) {
		...
		if (json.result_code == "Y") {
			var sf = JSON.parse(json.result_info);
			dwr.util.setValues(sf);
...
function doEditFunction() {
	...
	if (validator.form()) {
		...
		var url = "<%=context%>/app/sys/function/editFunction";
		url += "?t=" + new Date();
