		...
		<div class="row" style="margin:0px;padding:0px;">
			<div class="col-md-12" style="padding-left:5px;padding-right:5px;">
				<div id="structAttributeToolbar">
					<button id="addStructAttributeBtn" class="btn btn-<%=bootstrapSkin%> btn-sm" onclick="addStructAttribute();">
			            <i class="glyphicon glyphicon-plus"></i>&nbsp;新建
			        </button>
			        <button id="editStructAttributeBtn" class="btn btn-<%=bootstrapSkin%> btn-sm" onclick="editStructAttribute();">
			    ...
			    <table id="structAttributeTable"
			        ...
			        <thead>
			           	<tr>
			                ...
			                <th data-field="ddt_text" data-halign="center" data-align="left" data-sortable="true">数据结构</th>
...
function queryStructAttributeList() {
	...
	var url = "<%=context%>/app/sys/datastruct/getDataStructAttributeList";
    ...
    $.ajax({
		...
		success: function(data) {
			...
			if (json.result_code == "Y") {
				$("#structAttributeTable").bootstrapTable("load", JSON.parse(json.result_info));
...
function addStructAttribute() {
	var url = "<%=context%>/app/sys/datastruct/DataStructAttributeAdd";
	url += "?structCode=" + structCode;
...
function editStructAttribute() {
	...
	var url = "<%=context%>/app/sys/datastruct/DataStructAttributeEdit";
	url += "?structCode=" + structCode;
