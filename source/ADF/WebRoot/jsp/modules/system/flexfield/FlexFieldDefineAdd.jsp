...
<body class="my-body-content">
	<form id="defineAddForm" name="defineAddForm" class="my-form-content">
		<table class="my-form-table-content">
			<tr>
				...
				<td class="my-form-table-td-content" style="width:200px;">
					<input id="flex_code" name="flex_code" type="text" class="form-control input-sm" style="width:180px;padding:5px;float:left;">
				</td>
			</tr>
...
$(document).ready(function() {
	validator = $("#defineAddForm").validate({
		debug: true,
		...
		rules: {
			flex_code: {
				...
				isCode: true,
				remote: {
					url:"<%=context%>/app/sys/flexfield/checkFlexFieldCode?t=" + new Date(),
					type: "post",
					dataType: "json",
					data: {
...
function doAddFlexFieldDefine() {
	...
	if (validator.form()) {
		...
		var url = "<%=context%>/app/sys/flexfield/addFlexFieldDefine";
		url += "?t=" + new Date();
